  ...
  data: () => ({
    mapPlaces: [
      // 1Intro
      {
        ...
        slides: [
          {img:"/TrondheimTour/dreiers minne01.webp", buttons: [
            {
              left: -100, top: 200,
          ...
          {img:"/TrondheimTour/dreiers minne10.webp", buttons: []},
          {img:"/TrondheimTour/dreiers minne04.webp", buttons: []},
        ],
      },
      {
      // 2Helkansætra
      ...
      },
      {
        ...
        mapId: 3,
        slides:[
          {img:"/TrondheimTour/dreiers minne14.webp", buttons: [
            {
              left: 0, top: 0,
      ...
      },
      {
        ...
        mapId: 4,
        slides:[
          {img:"/TrondheimTour/dreiers minne25.webp", buttons: [
            {
              left: 0, top: -20,
          ...
          {img:"/TrondheimTour/dreiers minne28.webp", buttons: [
            {
              left: 0, top: 40,
          ...
          {img:"/TrondheimTour/dreiers minne32.webp", buttons: [
            {
              left: -100, top: 0,
      ...
      },
      {
        ...
        slides:[
          // 5Dreiers Minne
          {img:"/TrondheimTour/dreiers minne35.webp", buttons: [
            {
              left: 0, top: -100,
              roboText: "Etter en lang gåtur er det godt med drikkevann tilgjengelig!",
            },
          ]},
          {img:"/TrondheimTour/dreiers minne53.webp", buttons: [
            {
              left: 0, top: 0,
          ...
          {img:"/TrondheimTour/dreiers minne54.webp", buttons: [
            {
              left: 0, top: 0,
          ...
          {img:"/TrondheimTour/dreiers minne60.webp", buttons: [
            {
              left: 0, top: 0,
          ...
          {img:"/TrondheimTour/dreiers minne37.webp", buttons: [
            {
              left: 0, top: 0,
          ...
          {img:"/TrondheimTour/dreiers minne40.webp", buttons: []},
          {img:"/TrondheimTour/dreiers minne43.webp", buttons: []},
        ]
      },
      {
        // 6Lavollen
        mapId: 6,
        slides:[
          {img:"/TrondheimTour/dreiers minne67.webp", buttons: [
             {
              left: 0, top: 0, 
          ...
          {img:"/TrondheimTour/dreiers minne65.webp", buttons: [
            {
              left: 0, top: 0, 
